...
namespace ApertureLabs
{
    namespace AssemblyLoader
    {
        ...
        class AssemblyLoader
        {
            ...
            public static void LoadApp(string appPath)
            {
                ...
                {
                    Debug.Print(DisplayName + "v" + Version + " is running.");
                    return;
                }
    ...
    namespace System
    {
        ...
        class ProcessManager
        {
            ...
            /// </summary>
            private static Hashtable processes = null;
            /// <summary>
            ...
            public static void KillAll()
            {
                ...
                {
                    KillProcess(e.Key.ToString(), e.Value.ToString());
                }
                processes.Clear();
            }
            /// <summary>
            ...
            public static void KillProcess(string DisplayName, string AppPath)
            {
